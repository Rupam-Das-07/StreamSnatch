...
const Loader = ({ theme, onCancel }) => {
  return (
    // 2. Pass the theme prop to the styled component
...
const StyledWrapper = styled.div`
  .loader {
    /* 3. Use the theme prop to set the colors dynamically */
    --path: ${(props) => (props.theme === "dark" ? "#2f3545" : "#E5E7EB")};
    --dot: ${(props) => (props.theme === "dark" ? "#5628ee" : "#4F46E5")};
    --duration: 3s;
    width: 44px;
    height: 44px;
    position: relative;
  ...
  /* ... The rest of your original CSS code ... */
