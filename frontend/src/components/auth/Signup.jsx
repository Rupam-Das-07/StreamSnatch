    ...
    <div className="flex justify-center items-center w-full py-12 px-4 transition-all duration-300">
      <div className="bg-zinc-950/60 backdrop-blur-2xl border border-white/10 rounded-[24px] p-8 sm:p-10 w-full max-w-md shadow-2xl animate-fade-in-up">
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 text-sm mt-2">Join to save your favorite downloads</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-zinc-400">
          ...
          <a href="#" onClick={(e) => { e.preventDefault(); setActiveTab('login'); }} className="text-accent-cyan font-semibold hover:text-cyan-400 hover:underline underline-offset-4 transition-all">
            Login
          </a>
        </p>
      </div>
